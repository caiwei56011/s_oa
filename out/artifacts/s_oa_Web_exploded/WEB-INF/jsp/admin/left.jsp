	    ...
	    <div class="shumenu" >
	    	...
	    	<script type="text/javascript">
	    		...
	    		$.ajax({
	    			...
	    			dataType: "json",
	    			/**
	    			* 异步请求中的同步,必须响应数据完全加载完后,$.ajax({})后面的其它js代码才向下执行,
	    			* ajax 中异步加载数据有默认响应时间，数据加载慢时超过默认响应时间，其它js代码直接向下执行
	    			*/
	    			async: false, 
	    			success: function(data){
	    				...
	    				$.each(data, function(){
	    					...
	    					url = this.pid == "0" ? "" : url;
	    					tree.add(this.id, this.pid, this.name, url, this.name);
	    				});
	    		...
	    		tree.add(25,2,"操作管理","javascript:parent.mainframe.addTab('操作管理','admin/identity/mgrModule.jspx')","操作管理");
	    		...
	    		tree.add(5,1,"通讯录管理");
	    		tree.add(51,5,"联系组管理","javascript:parent.mainframe.addTab('联系组管理','admin/addressbook/selectContactGroup.jspx')", "联系组管理");
	    		tree.add(52,5,"联系人管理","javascript:parent.mainframe.addTab('联系人管理','admin/addressbook/mgrContact.jspx')", "联系人管理");
	    		*/
