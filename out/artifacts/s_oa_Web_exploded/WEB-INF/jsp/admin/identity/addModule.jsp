...
<body>
	<table align="center">
		...
		<s:form id="addModuleForm" name="addModuleForm" action="admin/identity/addModule.jspx" method="post" theme="simple">
			<!-- 防表单重复提交需要传入后台的参数 -->
			<s:token></s:token>
			<!-- 隐藏input保存parentCode，用于添加时生成新code -->
			<s:hidden name="parentCode"></s:hidden>
			<tr>
				<td>名称：</td>
				<td>
					<input type="text" name="module.name" size="30" maxlength="50" value="" id="name"/>
				</td>
			</tr>
			...
			<tr>
				<td>链接：</td>
				<td>
					<input type="text" name="module.url" size="30" maxlength="50" value="" id="url"/>
				</td>
			</tr>
			...
			<tr>
				<td>备注：</td>
				<td>
					<textarea rows="5" cols="30" name="module.remark"></textarea>
				</td>
			</tr>
			<tr>
