...
<body>
	<table align="center">
		...
		<s:form id="updateDeptForm" name="updateDeptForm" action="admin/identity/updateDept.jspx" method="post" theme="simple">
			<!-- 防表单重复提交需要传入后台的参数 -->
			<s:token></s:token>
			<!-- 隐藏域保存部门id -->
			...
			<tr>
				<td>部门名称：</td>
				<td>
					<s:textfield name="dept.name" size="" maxlength="50" id="name"></s:textfield>
				</td>
			</tr>
			...
			<tr>
				<td>部门备注：</td>
				<td>
					<s:textarea rows="5" cols="30" name="dept.remark"></s:textarea>
				</td>
			</tr>
			<tr>
