	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$("#exitBtn").click(function(){
				parent.window.location.href="${path}/admin/logout.jspx";
			});
			/** 修改密码按钮点击事件 */
			$("#updatePwdBtn").click(function(){
				parent.mainframe.showUpdatePwd();
			});
		});
	</script>
 ...
 <body class="headbody">
	<div class="headtitle" id="headtitle">
        ...
        <div class="headmenutop">
        	<a class="headtopout" id="exitBtn" title="退出系统" href="javascript:void(0);" style="margin-left: 5px;">安全退出</a>
        	<a class="headtopout" id="updatePwdBtn" title="密码修改" href="javascript:void(0);" >密码修改</a>
			<div class="titlexx">
