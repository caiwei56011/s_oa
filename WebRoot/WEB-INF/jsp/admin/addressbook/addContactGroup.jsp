...
<body>
	<table align="center">
		...
		<s:form id="addContactGroupForm" name="addContactGroupForm" action="/admin/addressbook/addContactGroup.jspx" method="post" theme="simple">
			<!-- 防表单重复提交需要传入后台的参数 -->
			<s:token></s:token>
			...
			<tr>
				<td>联系组名：</td>
				<td>
					<input type="text" name="contactGroup.name" size="30" maxlength="50" value="" id="name"/>
				</td>
			</tr>
			...
			<tr>
				<td>备&nbsp;&nbsp;&nbsp;&nbsp;注：</td>
				<td>
					<textarea rows="5" cols="30" name="contactGroup.remark"></textarea>
				</td>
			</tr>
			<tr>
