...
<body>
	<table align="center">
		...
		<s:form id="updateContactGroupForm" name="updateContactGroupForm" action="admin/addressbook/updateContactGroup.jspx" method="post" theme="simple">
			<!-- 防表单重复提交需要传入后台的参数 -->
			<s:token></s:token>
			<!-- 隐藏域保存联系组id -->
			...
			<tr>
				<td>联系组名：</td>
				<td>
					<s:textfield name="contactGroup.name" size="30" maxlength="50" id="name"></s:textfield>
				</td>
			</tr>
			...
			<tr>
				<td>备&nbsp;&nbsp;&nbsp;注：</td>
				<td>
					<s:textarea rows="5" cols="30" name="contactGroup.remark"></s:textarea>
				</td>
			</tr>
			<tr>
