...
<body>
	<table align="center">
		...
		<s:form id="addLeaveTypeForm" name="addLeaveTypeForm" action="admin/leave/addLeaveType.jspx" method="post" theme="simple">
			<!-- 防表单重复提交需要传入后台的参数 -->
			<s:token></s:token>
			<tr>
				<td>类型名称：</td>
				<td>
					<input type="text" name="leaveType.name" size="30" maxlength="50" value="" id="name"/>
				</td>
			</tr>
			<tr>
				<td>备注：</td>
				<td>
					<textarea rows="5" cols="30" name="leaveType.remark"></textarea>
				</td>
			</tr>
			<tr>
