...
<body>
	<table align="center">
		...
		<s:form id="updateLeaveTypeForm" name="updateLeaveTypeForm" action="admin/identity/updateLeaveType.jspx" method="post" theme="simple">
			<!-- 防表单重复提交需要传入后台的参数 -->
			<s:token></s:token>
			<!-- 隐藏域保存code -->
			<s:hidden name="leaveType.code"></s:hidden>
			<tr>
				<td>名称：</td>
				<td>
					<s:textfield name="leaveType.name" size="30" maxlength="50" id="name"></s:textfield>
				</td>
			</tr>
			<tr>
				<td>备注：</td>
				<td>
					<s:textarea rows="5" cols="30" name="leaveType.remark"></s:textarea>
				</td>
			</tr>
			<tr>
