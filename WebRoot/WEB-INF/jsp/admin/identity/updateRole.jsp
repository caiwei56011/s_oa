...
<body>
	<table align="center">
		...
		<s:form id="updateRoleForm" name="updateRoleForm" action="admin/identity/updateRole.jspx" method="post" theme="simple">
			<!-- 防表单重复提交需要传入后台的参数 -->
			<s:token></s:token>
			<!-- 隐藏域保存角色id -->
			...
			<tr>
				<td>角色名称：</td>
				<td>
					<s:textfield name="role.name" size="" maxlength="50" id="name"></s:textfield>
				</td>
			</tr>
			...
			<tr>
				<td>角色备注：</td>
				<td>
					<s:textarea rows="5" cols="30" name="role.remark"></s:textarea>
				</td>
			</tr>
			<tr>
