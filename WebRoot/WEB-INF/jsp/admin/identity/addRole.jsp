...
<body>
	<table align="center">
		...
		<form id="addRoleForm" name="addRoleForm" action="${path}/admin/identity/addRole.jspx" method="post">
			<!-- 防表单重复提交需要传入后台的参数 -->
			<s:token></s:token>
			...
			<tr>
				<td>角色名称：</td>
				<td>
					<input type="text" name="role.name" size="30" maxlength="50" value="" id="name"/>
				</td>
			</tr>
			...
			<tr>
				<td>角色备注：</td>
				<td>
					<textarea rows="5" cols="30" name="role.remark"></textarea>
				</td>
			</tr>
			<tr>
