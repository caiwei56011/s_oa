package com.jsoft.oa.core.common.sms;
...
public final class SmsUtils {
	...
	/** ################# 需要根据情况填写下面的属性 #################### */
	/** 应用的key */
	private final static String APP_KEY = "23439661";
	/** 应用的签名 */
	private final static String APP_SECRET = "d0f9dd1337f9ea69c63f2fdc24744ca7";
	/** 短信签名 */
	private final static String SMS_FREE_SIGN_NAME = "oa办公平台";
	/** 短信模板ID */
	private final static String SMS_TEMPLATE_CODE = "SMS_13186555";
	/** ################# 需要根据情况填写上面的属性 #################### */
	...
	public static boolean send(String code, String phones){
		try{
			 ...
			 *      您正在oa办公平台进行身份验证，验证码是${code},感谢使用本平台。
			 * (可选)
			 */
